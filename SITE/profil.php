        ...
        <div class="container-fluid" style="column-count: 2;">
            <div id="div2">
                <div id="bloc" style="column-count: 2; margin: 0;">
                    <span>Prenom</span>
                    <input type="text" id="entered" placeholder="<?php echo $_SESSION['prenom'];?>" readonly>
                </div>
                <div id="bloc" style="column-count: 2;">
                    <span>Classe</span>
                    <input type="text" id="entered" placeholder="<?php echo $_SESSION['niveau'];?>" readonly>
                </div>
                <div id="bloc" style="column-count: 2;">
                    <span>Nom</span>
                    <input type="text" id="entered" placeholder="<?php echo $_SESSION['nom'];?>" readonly>
                </div>

                <div id="bloc" style="column-count: 2;">
                    <span>Email</span>
                    <input type="email" id="entered" placeholder="<?php echo $_SESSION['email'];?>" readonly>
                </div>
            </div>
