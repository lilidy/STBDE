        ...
        <div class="collapse navbar-collapse center" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link space" href="accueil.php">Acceuil <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link space" href="calendrier.html">Calendrier <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link space" href="team.php">Equipe <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
